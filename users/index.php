...
function valid()
{
	...
	//Client-side form validation to check if the password and confirm password fields match
...
<input type="password" class="form-control unicase-form-control text-input" placeholder="Confirm Password" id="confirmpassword" name="confirmpassword" required >
    ...
    <script>
        $.backstretch("assets/img/login-bg.jpg", {speed: 500});//custom js scripts for passing path to the background image
    </script>
